                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-xl border border-white/10 hover:bgoblue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                {["Figma"].map((tech, key) =>  <span key={key} className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bgoblue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition">
                                        {tech}</span>)}
                            </div>
